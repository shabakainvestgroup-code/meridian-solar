...
const projects = [
  ...
  },
  {
    ...
    year: "2024",
    description:
      "Couverture complète des besoins en eau chaude sanitaire et climatisation d'un hôtel 5 étoiles. ROI atteint en 3 ans.",
    color: "gold",
  ...
  },
  {
    ...
    location: "Région Marrakech-Safi",
    power: "30 kWc",
    saving: "100%",
    year: "2023",
    description:
  ...
  },
  {
    ...
    year: "2023",
    description:
      "Grande installation en toiture pour un centre commercial. Économie de 2,4 millions de DH/an.",
    color: "gold",
  ...
  },
  {
    ...
    year: "2023",
    description:
      "Projet RSE en faveur d'une école primaire publique. Alimentation en électricité propre pour 400 élèves.",
    color: "navy",
